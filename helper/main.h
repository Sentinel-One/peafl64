...
#define IOCTL_HELPER_GET_SECTION_ADDRESS	   CTL_CODE(FILE_DEVICE_UNKNOWN, 801, METHOD_BUFFERED, FILE_ANY_ACCESS) //0x220c84
#define IOCTL_HELPER_READ_MEMORY               CTL_CODE(FILE_DEVICE_UNKNOWN, 802, METHOD_BUFFERED, FILE_ANY_ACCESS) //0x220c88
